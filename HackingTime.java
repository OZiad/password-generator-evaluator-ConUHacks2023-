...
public class HackingTime extends FatherPassword {             
    ...
    public static String passwordGenerator(int length, boolean useUpperCase, boolean useLowerCase, boolean useNumbers,
            boolean useSymbols) {
        ...
        if (useUpperCase) {
            ...
            password.append(upperCaseLetters.charAt(rnd.nextInt(upperCaseLetters.length()))); // Appending an variable
                                                                                              // to string password.
            length--;
        }
        if (useLowerCase) {
...
=======
        ...
        if (FatherPassword.randomness(password) >= 3) {
>>>>>>> 0f46c322a3ee80c261c921adea465d7b8d5a57b6
            score++;
        // }
